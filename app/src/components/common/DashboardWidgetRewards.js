    ...
    return(
      <View style={{width: '100%', marginBottom: 10}}>
        ...
        <View style={{flexDirection: 'row', alignItems: 'flex-start', justifyContent:'center', backgroundColor: 'white', paddingHorizontal:10, paddingBottom: 10}}>
          <View style={{flex: 1, flexDirection: 'column', alignItems:'center', backgroundColor: 'black', marginEnd: 5}}>
          ...
          <View style={{flex: 1, flexDirection: 'column', alignItems:'center', backgroundColor: 'black', marginStart: 5}}>
