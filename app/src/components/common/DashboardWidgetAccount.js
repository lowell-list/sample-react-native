    ...
    return(
      <Animated.View style={{
        ...
        <View style={{flexDirection: 'row', alignItems: 'flex-start', justifyContent:'center', backgroundColor: 'white'}}>
          <Text style={{color: DIRECT_GRAY, fontSize: 35, fontFamily: 'open-sans-semibold'}}>{this.props.dollars}</Text>
          <Text style={{color: DIRECT_GRAY, fontSize: 28, fontFamily: 'open-sans-semibold'}}>{this.props.cents}</Text>
        </View>
